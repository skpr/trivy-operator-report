...
require (
	...
	github.com/aquasecurity/trivy v0.65.0 // indirect
...
replace github.com/aquasecurity/trivy-operator => github.com/skpr/trivy-operator v0.0.0-20250829013341-90f745cb37b2
